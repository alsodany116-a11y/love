...
const DEFAULTS = {
  settings: {
    ...
    letterText: "إلى تلك الجميلة التي ملأت حياتي دفئاً وحباً..\n\nمنذ أن التقيت بكِ والعالم يبدو مكاناً أكثر جمالاً. كل يوم يمر بجانبكِ هو هدية من السماء، وقصتنا التي نكتبها معاً هي أثمن ما أملك.\n\nأكتب لكِ هذه الكلمات لتظل شاهدة على حبٍ لن يمحوه الزمن، وعلى روحين التقتا في عهد أبدي من العشق الكلاسيكي.. أحبكِ اليوم وغداً وإلى الأبد.",
